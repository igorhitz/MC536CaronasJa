    ...
    <body>
        ...
        <div id="menu-principal">
            <div class="wrapper">
                <nav id="menu">
                    <ul>
                        <li><a href="<?= PATH_HREF ?>Home" class="PrincipAtivo"><b>Home</b></a></li>
                        <li><a><b>Caronas</b></a>
							<ul>
						...
						<li><a href="<?= PATH_HREF ?>buscaUsuarios"><b>Usuários</b></a></li>
						<li><a href="<?= PATH_HREF ?>veiculo"><b>Veículo</b></a></li>
						<li><a href="<?= PATH_HREF ?>grupo"><b>Grupos</b></a>
							<ul>
